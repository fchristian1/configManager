...
import { deleteOne, find, findOne, findOneWithoutUserId, findWithoutUserId, insertOne } from "../db/mongo.js";

const collectionName = "modulesConfig";

export const controllerModulesConfig = {
    async getAll(req, res) {
        const data = await findWithoutUserId(collectionName);
        res.json(data);
    },
    async getOne(req, res) {
        const id = req.params.id;
        const data = await findOneWithoutUserId(collectionName, id);
        res.json(data);
    },
